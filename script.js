...
async function it() {
    ...
    try {
        ...
        // GAS側のキー名(ruby, junk)と一致している必要があります
...
function sy() {
    ...
    if(rem) rem.innerText = `残り：${100 - sumP}%`;
...
function calc() {
    ...
    try {
        ...
        document.getElementById('resDmg').innerText = totalDmg.toLocaleString();
